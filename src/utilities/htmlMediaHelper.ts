...
export function saveVolume(value?: any) {
  if (value) {
    appSettings.set('volume', value);
  }
}

export function getCrossOriginValue(mediaSource: any) {
...
export function enableHlsJsPlayer(runTimeTicks: any, mediaType: string) {
...
let recoverDecodingErrorDate: any;
let recoverSwapAudioCodecDate: any;
export function handleHlsJsMediaError(instance: any, reject: any) {
...
export function onErrorInternal(instance: any, type: any) {
  // Needed for video
...
export function isValidDuration(duration: any) {
  return (
    duration &&
    !isNaN(duration) &&
...
function setCurrentTimeIfNeeded(element: any, seconds: any) {
...
export function seekOnPlaybackStart(
  ...
  if (seconds) {
    ...
    if (element.duration >= seconds) {
      ...
      const onMediaChange = function (e: any) {
...
export function applySrc(elem: any, src: any, options: any) {
  if ((window as any).Windows && options.mediaSource?.IsLocal) {
    return Windows.Storage.StorageFile.getFileFromPathAsync(options.url).then(
      function (file: any) {
...
export function resetSrc(elem: any) {
  elem.src = '';
  elem.innerHTML = '';
  elem.removeAttribute('src');
}

function onSuccessfulPlay(elem: any, onErrorFn: any) {
  elem.addEventListener('error', onErrorFn);
}

export function playWithPromise(elem: any, onErrorFn: any) {
  try {
    return elem
      .play()
      .catch((e: any) => {
...
export function destroyCastPlayer(instance: any) {
...
export function destroyHlsPlayer(instance: any) {
...
export function destroyFlvPlayer(instance: any) {
...
export function onEndedInternal(instance: any, elem: any, onErrorFn: any) {
...
export function getBufferedRanges(instance: any, elem: any) {
  const ranges = [];
